package com.jgeun.fastcampus.sns.hiltextension.compiler
...
class InstallBindingProcessor : AbstractProcessor() {
	...
	private fun processElement(typeElement: TypeElement) {
		...
		val component = annotation.elementValues[annotationProperties["component"]]?.value as? DeclaredType ?: error("component 값을 찾을 수 없습니다")
